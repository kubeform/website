...
url: /docs/v0.1.0/welcome/contributing/
aliases:
- /docs/v0.1.0/CONTRIBUTING/
info:
  version: v0.1.0
---
...
We have a [Developer Guide](/docs/v0.1.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
